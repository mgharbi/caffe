#ifndef NORMALIZED_EUCLIDEAN_LOSS_LAYER_HPP_I1KBFJVB
#define NORMALIZED_EUCLIDEAN_LOSS_LAYER_HPP_I1KBFJVB
...
class NormalizedEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  ...
  /**
   * Unlike most loss layers, in the NormalizedEuclideanLossLayer we can backpropagate
 ...
 protected:
  /// @copydoc NormalizedEuclideanLossLayer
   ...
   *
   * Unlike other children of LossLayer, NormalizedEuclideanLossLayer \b can compute
...
#endif /* end of include guard: NORMALIZED_EUCLIDEAN_LOSS_LAYER_HPP_I1KBFJVB */
