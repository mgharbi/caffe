...
template <typename Dtype>
void CaffeCropLayer<Dtype>::crop_copy_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void CaffeCropLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void CaffeCropLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(CaffeCropLayer);
